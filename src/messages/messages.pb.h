...
enum MessageType {
  ...
  MessageType_HdsSignMessage = 902,
  MessageType_HdsSignature = 903,
  MessageType_HdsVerifyMessage = 904,
  MessageType_HdsGetPublicKey = 905,
  MessageType_HdsGetOwnerKey = 907,
  MessageType_HdsOwnerKey = 908,
  MessageType_HdsGenerateKey = 909,
  MessageType_HdsGenerateNonce = 910,
  MessageType_HdsECCPoint = 911,
  MessageType_HdsGenerateRangeproof = 912,
  MessageType_HdsRangeproofData = 913,
  MessageType_HdsSignTransaction = 914,
  MessageType_HdsSignedTransaction = 915,
  MessageType_HdsGetNoncePublic = 916,
  MessageType_HdsSignTransactionSend = 917,
  MessageType_HdsSignTransactionSendResult = 918,
  MessageType_HdsSignTransactionReceive = 919,
  MessageType_HdsSignTransactionReceiveResult = 920,
  MessageType_HdsSignTransactionSplit = 921,
  MessageType_HdsSignTransactionSplitResult = 922,
  MessageType_HdsGetNumSlots = 923,
  MessageType_HdsNumSlots = 924,
  MessageType_HdsGetPKdf = 925,
  MessageType_HdsPKdf = 926
};
